...
public class RangeSliderUI extends JPanel implements MouseMotionListener {

	private static final int width = 10;
	private static final int MAX = 100;
	private Rectangle[] rect = new Rectangle[MAX];
	private int rec_numbers = 0;
	...
	public void add(int x, int y) {
		...
		if (rec_numbers < MAX) {
			...
			rect[rec_numbers] = new Rectangle(x, y, width, width);

			currentSquareIndex = rec_numbers;
